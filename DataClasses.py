...
# fabiosacca, 2022-Dec-13, Modified to add Track class constructors, properties, methods 
#------------------------------------------#
...
class CD:
    ...
    def cd_title(self, value):
        try:
            ...
            raise Exception('Title needs to be a string of text!')
    ...
    def cd_artist(self, value):
        try:
            ...
            raise Exception('Artist needs to be a string of text!')
